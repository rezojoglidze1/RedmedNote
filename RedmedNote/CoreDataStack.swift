...
//using the default file manager  by doing filemanager . i want to get url from users document directory.
//file manager gave us a file path, but we need an actual file with a extension.
extension URL {
